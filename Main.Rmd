...
names(pheno_vector_absolut) = pheno_vector_separation
...
pheno_vector_separation = NULL
colors_absolut_separation = NULL

# convention to thresholding data - COMMENT LINES 82 TO 86 FOR COMPLETE PHENOTYPING
...
for (samplename_long in paths[5]){
  ...
  #   output_dir <- file.path("fig","Complete Phenotype", samplename)
  #   
  ...
  output =  do_analyse(Intable = data, PhenoOrder = pheno_vector_absolut, ColsOrder = colors_absolut, phenotype = pheno_vector_separation, colors_phenotype = colors_absolut_separation, plotter = plotter_bools, fig.prefix = '.', XposCol = 'Cell X Position', YposCol = 'Cell Y Position', PhenoCol = 'Phenotype', sample_name = samplename, r_vec = r_vec, options = selected_options, envelope_bool = TRUE)
  
  # output =  do_analyse(Intable = data_with_distance, PhenoOrder = pheno_vector_absolut, ColsOrder = colors_absolut, phenotype = NULL, plotter = plotter_bools, fig.prefix = './', XposCol = 'Cell X Position', YposCol = 'Cell Y Position', PhenoCol = 'Phenotype', sample_name = samplename, r_vec = r_vec, options = selected_options, envelope_bool = TRUE)
