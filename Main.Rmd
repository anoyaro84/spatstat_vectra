...
for (samplename in paths[1:1]){
  
  samplename = "C:/Users/erikb/Documents/Thesis - Local/Data Marit voor Erik Bosch/Erik Bosch/Data complete phenotyping/HO105_Exported data tables/HO105-194_[16067,37856]_cell_seg_data.txt" # PD-L1 positive cluster + Tumor cluster
  print(paste("path of data is ", samplename))
  data = purrr::map_df(samplename, read_cell_seg_data, pixels_per_micron = getOption("phenoptr.pixels.per.micron"))
  
  samplename = str_replace(samplename,"C:/Users/erikb/Documents/Thesis - Local/Data Marit voor Erik Bosch/Erik Bosch/Data complete phenotyping/HO105_Exported data tables/","")
  ...
  output =  do_analyse(Intable = data_with_distance, PhenoOrder = pheno_vector_absolut, Cols = colors_absolut, phenotype = NULL, plotter = c(FALSE,FALSE), XposCol = 'Cell X Position', YposCol = 'Cell Y Position', PhenoCol = 'Phenotype', sample_name = samplename, r_vec = r_vec)
  ...
  density_sample = output[[3]]
  MED_min = output[[4]]
  MED = output[[5]]
  MAD_min = output[[6]]
  MAD = output[[7]]
  r_close_list = output[[8]]
  statistic_close_list = output[[9]]
  all_types_options_sample_name = output[[10]]
...
output = do_analyse(data_with_distance, pheno_vector_absolut, colors_absolut, NULL, plotter = c(FALSE,FALSE),XposCol = 'Cell X Position', YposCol = 'Cell Y Position',PhenoCol = 'Phenotype', samplename, r_vec = r_vec)
