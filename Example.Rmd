...
base_path <- '../Exported data tables/'
...
for (file in extreme){
	...
	outputs[[samplename]] = do_analyse(Intable = data_with_distance, PhenoOrder= phenotype_simple, 
                ColsOrder = color_simple, plotter = c(TRUE, TRUE,TRUE),XposCol = 'Cell X Position', envelope=TRUE, 
			    fig.prefix = './simple/', fig.width = 720, fig.height = 720,
