...
for (file in extreme){
	...
	outputs_auto[[samplename]] = do_analyse(Intable = data_auto, PhenoOrder = phenotype_complete, ColsOrder = color_complete,
...
M_auto = feature_extract(outputs_auto, fig.prefix.complete)
```
