...
for (file in extreme){
	...
	outputs[[samplename]] = do_analyse(Intable = data, PhenoOrder= phenotype_simple, 
                ColsOrder = color_simple, plotter = c(FALSE, TRUE,TRUE),XposCol = 'Cell X Position', envelope=TRUE, 
